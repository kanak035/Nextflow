  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-900 shadow-lg p-3 w-64 min-w-[250px]">
      ...
      <div className="flex flex-col items-center justify-center p-4 border-2 border-dashed border-slate-700 rounded-lg bg-slate-950/50 hover:bg-slate-800 transition-colors cursor-pointer group">
        <UploadCloud size={24} className="text-slate-500 group-hover:text-amber-400 mb-2 transition-colors" />
        <span className="text-[10px] text-slate-400 font-medium">Click or Drag Video here</span>
        <span className="text-[9px] text-slate-600 mt-1">supports mp4, mov, webm</span>
      </div>
      {/* Output Handle - Video URL out */}
